...
legacy-isrdata stores large files using [git-lfs](https://git-lfs.github.com/). To use legacy-isrdata you must install git-lfs and configure it. LSST runs its own git-lfs server and storage service.
...
```bash
git clone https://github.com/lsst-dm/legacy-isrdata.git
```
